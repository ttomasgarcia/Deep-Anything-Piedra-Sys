...
- Salida en **grises** (z-depth para compositing) o **color** (Turbo / Magma para preview).
- Controles de resolución de proceso, FPS de salida e inversión (cerca = blanco).
- Normalización global del clip para reducir el *flicker* temporal.
- Modelo por defecto: `depth-anything/DA3MONO-LARGE` (depth monocular relativo, por frame).
